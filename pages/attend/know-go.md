...
-   Download a graphic and pair it with your own message. Be sure to use the hashtag #usrse25 and tag us so we can amplify your post!
    ...
    - Click to view and download: <a href="https://github.com/USRSE/usrse25/blob/main/assets/img/presenter_graphic.png" target="_blank">USRSE'25 Promotional Graphic - Presenter</a>
    - Click to view and download: <a href="https://github.com/USRSE/usrse25/blob/main/assets/img/attendee_graphic.png" target="_blank">USRSE'25 Promotional Graphic - Attendee</a>
